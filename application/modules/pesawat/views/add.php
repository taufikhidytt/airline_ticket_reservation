...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Add Pesawat</li>
    </ol>
</section>
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group <?= form_error('kode_pesawat') ? 'has-error' : null ?>">
                            ...
                            <input type="text" name="kode_pesawat" id="kode_pesawat" class="form-control" placeholder="Masukan Kode Pesawat" autocomplete="off" value="<?= $this->input->post('kode_pesawat')?>">
                        ...
                        <div class="form-group <?= form_error('nama_pesawat') ? 'has-error' : null ?>">
                            ...
                            <input type="text" name="nama_pesawat" id="nama_pesawat" class="form-control" placeholder="Masukan Nama Pesawat Anda" autocomplete="off" value="<?= $this->input->post('nama_pesawat')?>">
                        ...
                        <div class="form-group <?= form_error('keberangkatan_pesawat') ? 'has-error' : null ?>">
                            ...
                            <input type="text" name="keberangkatan_pesawat" id="keberangkatan_pesawat" class="form-control" placeholder="Masukan Keberangkatan Pesawat" autocomplete="off" value="<?= $this->input->post('keberangkatan_pesawat')?>">
                        ...
                        <div class="form-group <?= form_error('tujuan_pesawat') ? 'has-error' : null ?>">
                            ...
                            <input type="text" name="tujuan_pesawat" id="tujuan_pesawat" class="form-control" placeholder="Masukan Tujuan Pesawat" autocomplete="off" value="<?= $this->input->post('tujuan_pesawat')?>">
                        ...
                        <div class="form-group <?= form_error('harga') ? 'has-error' : null ?>">
                            ...
                            <input type="number" name="harga" id="harga" class="form-control" placeholder="Masukan Harga Ticket Pesawat Dalam Rupiah" autocomplete="off" value="<?= $this->input->post('harga')?>">
