            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped text-center" id="tablepesawat">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?= $no++?></td>
                            <td><?= $data->nama_customers?></td>
                            <td><?= $data->alamat_customers?></td>
                            <td><?= $data->no_hp?></td>
                            <td><?= $data->no_bangku?></td>
                            <td><?= $data->kode_pesawat?></td>
                            <td>
                                <a href="<?= base_url('customers/update/'.$data->id_customers)?>" class="btn btn-primary btn-xs">
                                    <i class="fa fa-edit"></i>
                                </a> |
                                <form action="<?= base_url('customers/del')?>" method="post" class="inline">
                                    <input type="hidden" name="id_customers" value="<?= $data->id_customers?>">
